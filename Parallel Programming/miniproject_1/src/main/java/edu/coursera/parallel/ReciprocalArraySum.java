...
public final class ReciprocalArraySum {
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for (int i = 0; i < numTasks; i++) {
        	int chunkStartIndexInclusive = getChunkStartInclusive(i, numTasks, input.length);
        	int chunkEndIndexExclusive = getChunkEndExclusive(i, numTasks, input.length);
        	tasks[i] = new ReciprocalArraySumTask(chunkStartIndexInclusive, chunkEndIndexExclusive, input);
        }
